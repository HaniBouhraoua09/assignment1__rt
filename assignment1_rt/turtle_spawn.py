...
class TurtleSpawner(Node):
    def __init__(self):
        ...
        # Clients for Spawn and Kill services
    ...
    def setup_turtles(self):
        # 1. KILL the default turtle1 (to reset the board)
        self.get_logger().info("Resetting Turtle 1...")
        ...
        # 2. SPAWN Turtle 1 (Purple - Center)
        # [cite_start]We assume 'turtle1' name gives the purple icon [cite: 1342]
        req1 = Spawn.Request()
        req1.x = 5.5
        req1.y = 5.5
        req1.theta = 0.0
        ...
        self.get_logger().info('Turtle 1 Spawned (Center)')

        # 3. SPAWN Turtle 2 (Green - Different Position)
        # Random coordinates between 1.0 and 10.0 to ensure it is valid but distinct
        req2 = Spawn.Request()
